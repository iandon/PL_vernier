...
%      screen params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
screenVar = struct('num', max(Screen('Screens')), 'rectPix',{[0 0  1280 1024]}, 'dist', {57}, 'size', {[41 30]},...
                    'res', {[1280 1024 ]}, 'calib_filename', {'0001_gluon_091102.mat'}); 
screenVar.centerPix = [screenVar.rectPix(3)/2 screenVar.rectPix(4)/2];
% 0001_gluon_091102
%~purplab/mgl/task/displays/0003_fechner_100212.mat
    % In a new screen, run:
...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('sizeDeg', {[2 2]}, 'cyclesPerDeg', {2}, 'phase_offset', {rand(1)*pi*2},...
    'dur', {.400}, 'possibleAngles', {[350, 10]}, 'num', {2}, 'contrast', {[1]},...
    'XdistDeg',{5}, 'YdistDeg', {0}, 'radiusDeg',{5}, 'bkColor', {screenVar.bkColor});  
%sqslope = sqrt(2*(stim.radiusDeg^2)); hfslp = 0.5*sqslope;
stim.radiusPix = deg2pix1Dim(stim.radiusDeg, ratioX);
stim.cyclesPerImage = stim.cyclesPerDeg*stim.sizeDeg(1);
...
postCueVar = struct('color',{black},'bkColor', {screenVar.bkColor}, 'penWidthPix', {4},...
                    'sizeDeg', {0.05}, 'centerPix', {screenVar.centerPix}, 'dur', {0.3}); 
...
%      Trial params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trialVars = struct('numTrialsInBlock', {20}, 'validity', {0}); 
...
%      Save Data params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
saveVars = struct('fileName', {'contTest'}, 'expTypeDirName', {'100contrast'});
